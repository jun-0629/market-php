<?php
	...
	$count_sql = "select id, name, birthday, email, hand_phone from member";
	...
	$sql = "select id, name, birthday, email, hand_phone from member ORDER BY join_date DESC LIMIT {$min_count},{$number_of_data}";
				...
				<div class="member_top">
					...
					<span class="search_view">
						<select name="search_type">
							...
							<option value="hand_phone">핸드폰번호</option>
